...
levels[1].views = [ { name: 'Summaries', es: { index: index, type: 'cores'        , source: {excludes: ['*.vals', '*._geo_envelope'], includes: ['summary._incomplete_summary', 'summary.contribution.*', 'summary.' + 'cores'        + '.*', 'summary._all.*']} }} ,
                    { name: 'Cores Map', es: { index: index, type: 'cores'        , source: {excludes: [                           ], includes: ['summary._incomplete_summary', 'summary.contribution.*', 'summary.' + 'cores'        + '.*', 'summary._all._geo_point']} }} ,
                    { name: 'Cores Plots', es: { index: index, type: 'cores'        , source: {excludes: [                           ], includes: ['summary._incomplete_summary', 'summary.contribution.*', 'summary.' + 'cores'        + '.*', 'summary._all.*']} }} ,
...
levels[2].views = [ { name: 'Summaries', es: { index: index, type: 'sections'     , source: {excludes: ['*.vals', '*._geo_envelope'], includes: ['summary._incomplete_summary', 'summary.contribution.*', 'summary.' + 'sections'     + '.*', 'summary._all.*']} }} ,
...
levels[3].views = [ { name: 'Rows'     , es: { index: index, type: 'measurements'  , source: {excludes: ['*.vals', '*._geo_envelope'], includes: ['summary._incomplete_summary', 'summary.contribution.*', 'summary.' + 'measurements'  + '.*', 'summary._all.*']}    , countField: 'summary.measurements._n_results' }} ];
