...
export const model = {
  ...
  tables: {
    contribution: {
      ...
      columns: {
        ...
        timestamp: {
          ...
          position: 3,
          type: "Timestamp",
          description: "Date and time the contribution was published",
          notes:
        ...
        is_reviewed: {
          ...
          unit: "Flag",
          description:
            "Contribution has been reviewed for correct usage of the CDR Data Model",
          validations: ['cv("boolean")', "downloadOnly()"],
        },
        data_model_version: {
    ...
    cores: {
      ...
      columns: {
        ...
        row_id: {
          ...
          position: 2,
          type: "Integer",
          description: "Unique row ID within a CDR Contribution",
          examples: ["743"],
          validations: ["downloadOnly()"],
        },
        core: {
        ...
        mbs_top: {
          label: "Core Top Depth Below Surface",
          group: "Core",
          position: 15,
          type: "Number",
          unit: "m",
          description:
            "Depth below sea floor or ground surface at the top of the core",
        },
        lat: {
          label: "Latitude",
          group: "Geography",
        ...
        lat_sigma: {
          ...
          unit: "Degrees",
          description:
            "Drill site geographic location averaging uncertainty, Latitude",
        ...
        lon_sigma: {
          ...
          unit: "Degrees",
          description:
            "Drill site geographic location averaging uncertainty, Longitude",
          notes: "Standard error or standard deviation at one sigma",
        ...
        geographic_precision: {
          ...
          unit: "Degrees",
          description:
            "Drill site geographic location, Precision in latitude and longitude",
        ...
        mst_processing_params: {
          label: "MST Processing Parameters",
          group: "Metadata",
          position: 30,
          type: "Dictionary",
          description:
            "Dictionary of parameters and values used during processing of MST data",
        },
        ...
        repository_links: {
          ...
          type: "Dictionary",
          description:
            "Display name for the curating repository and the permanent URL for this core",
          examples: [
            "OSU-MGR[https://osu-mgr.org/OSU-OD1507-18GC]",
            "OSU-MGR[https://osu-mgr.org/OSU-OD1507-18GC]:IODP[https://iodp.tamu.edu/janusweb/]",
          ],
        },
      },
    },
    ...
    sections: {
      label: "Sections",
      position: 3,
      description: "Full round or section-half of a core",
      ...
      columns: {
        ...
        type: {
          ...
          position: 6,
          type: "String",
          description: "Work or archive section half or full round section",
          examples: ["working", "archive", "full"],
          validations: ["required()"],
        },
        number: {
          ...
          type: "Number",
          description:
            "Number of section in the core starting at the top with 1",
          examples: [
            "2017",
            "2014-04-21",
            "1970-01-01T00:00:00",
        ...
        depth_top: {
          label: "Section Top Depth",
          group: "Section",
          position: 9,
          type: "Number",
          unit: "cm",
          description:
            "Depth of the section top relative to the top of the core",
          examples: [
            "2017",
            "2014-04-21",
            "1970-01-01T00:00:00",
          ...
          validations: ["min(0)", "max(cores.length)"],
        },
        depth_bottom: {
          label: "Section Bottom Depth",
          group: "Section",
          position: 10,
          type: "Number",
          unit: "cm",
          description:
            "Depth of the section bottom relative to the top of the core",
    ...
    measurements: {
      ...
      columns: {
        ...
        depth: {
          ...
          unit: "m",
          description:
            "Position of the measurement relative to the top of the section",
        },
        mbs_corrected: {
          label: "Measurement Corrected Depth",
          group: "Description",
          position: 8,
          type: "Number",
          unit: "m",
          description:
            "Depth below surface of the measurement with corrections applied",
        },
        thickness: {
          label: "Measurement Thickness",
          group: "Description",
          position: 9,
          type: "Number",
          unit: "m",
          description:
            "The maximum thichness of the section or section-half at the measurement depth",
        },
        standard: {
        ...
        raw_ctd: {
          label: "Raw Core Thickness Deviation",
          group: "Multi-Sensor Track (MST)",
          position: 16,
          type: "Number",
          unit: "mm",
          description: "Core Thickness Deviation, uncalibrated",
        },
        raw_pwave_t: {
          label: "Raw P-Wave Travel Time",
          group: "Multi-Sensor Track (MST)",
          position: 17,
          type: "Number",
          unit: "µs",
          description: "P-Wave travel time, uncalibrated",
        },
        raw_pwave_a: {
          label: "Raw P-Wave Signal Amplitude",
          group: "Multi-Sensor Track (MST)",
          position: 18,
          type: "Number",
          unit: "SI Dimensionless",
          description: "P-Wave signal amplitude, uncalibrated",
        },
        raw_gamma: {
          label: "Raw Attenuated Gamma Counts",
          group: "Multi-Sensor Track (MST)",
          position: 19,
          type: "Number",
          unit: "cps",
          description: "Attenuated gamma counts per second, uncalibrated",
        },
        raw_mag_susc: {
          ...
          type: "Number",
          unit: "SI Dimensionless",
          description: "Magnetic susceptibility, uncalibrated",
        },
        raw_temp: {
          ...
          type: "Number",
          unit: "Celcius",
          description: "Temperature, uncalibrated",
        },
        raw_res: {
          label: "Raw Electrical Resistivity",
          group: "Multi-Sensor Track (MST)",
          position: 22,
          type: "Number",
          unit: "mV",
          description: "Resistivity, uncalibrated",
        },
        pwave_a: {
        ...
        fp: {
          label: "Fractional Porosity",
          group: "Multi-Sensor Track (MST)",
          position: 27,
          type: "Number",
          unit: "SI Dimensionless",
          description: "Fractional porosity",
        },
        imp: {
    ...
    supplements: {
      ...
      notes:
        "Reports, Line-scan images, CT scan DICOM files, raster or vector plots",
      columns: {
        contribution_id: {
          label: "Contribution ID",
          group: "Contribution",
