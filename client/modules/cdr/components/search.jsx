...
import { levels, index } from "/lib/configs/cdr/search_levels.js";
import { cvs } from "/lib/modules/er/controlled_vocabularies";
import { elements } from "/lib/configs/cdr/elements.js";

const elementsByPosition = {};
elements.map((element) => {
  elementsByPosition[element.xpos] = elementsByPosition[element.xpos] || {};
  elementsByPosition[element.xpos][element.ypos] = element;
});
...
class Search extends React.Component {
  filters = [
    ...
    },
    {
      ...
      title: "Research Scientist Name",
      term: "summary._all.scientists.raw",
      aggs: {
        buckets: {
          terms: { field: "summary._all.scientists.raw", size: 10000 },
        },
      },
    },
    {
      render: this.renderBucketsFilter.bind(this),
      name: "summary._all.analysts",
      title: "Analyst Name",
      term: "summary._all.analysts.raw",
      aggs: {
        buckets: { terms: { field: "summary._all.analysts.raw", size: 10000 } },
      },
    },
    {
      render: this.renderBucketsFilter.bind(this),
    ...
    //{ render: this.renderWithDataFilter.bind(this)       ,                     name: 'withExperimentsData'                         , title: 'With Experiments Table Data'   , summaryLevel: 'experiments' , exists: true  },
    //{ render: this.renderWithDataFilter.bind(this)       ,                     name: 'withoutExperimentsData'                      , title: 'Without Experiments Table Data', summaryLevel: 'experiments' , exists: false },
    {
      render: this.renderWithDataFilter.bind(this),
      name: "withMeasurementsData",
      title: "With Measurements Table Data",
      summaryLevel: "measurements",
      exists: true,
    },
    {
      render: this.renderWithDataFilter.bind(this),
      ...
      <div className="cdr-search">
          ...
          {Cookies.get(
            ...
            <div className="right menu">
              <div className="item" style={{ paddingRight: 0 }}>
                <Link
                  className={portals["CDR"].color + " ui compact button"}
        ...
        >
          <div style={{ display: "flex", width: "100%" }}>
            ...
            >
              <div className={portals["CDR"].color + " ui label"}>
            ...
            {this.state.search.indexOf("private_key:") === -1 && (
              <SearchDownload
                className={portals["CDR"].color + " ui basic button"}
  ...
  renderDeclinationFilter(searchQueries, filter, i) {
    return (
      <div key={i + "_" + this.state.filtersTap} style={this.styles.filter}>
        <div
          className="ui right floated tiny compact icon button"
            ...
            <input
              ...
              onChange={(e) => {
                this.handleNumericInput(
                  ...
                  e.target.value,
                  0,
                  _.isNumber(this.state.dec_max) ? this.state.int_max : 360
                );
              }}
            />
          </div>
          <div className="ui label" style={{ borderRadius: 0, margin: 0 }}>
            to
          </div>
          <div
            className={
            ...
            <input
              ...
              onChange={(e) => {
                this.handleNumericInput(
                  "dec_max",
                  e.target.value,
                  _.isNumber(this.state.dec_min) ? this.state.dec_min : 0,
                  360
                );
              }}
            />
  ...
  renderWithDataFilter(searchQueries, filter, i) {
    ...
    sortedTables.forEach((tableKey) => {
      if (
        ...
        (filter.summaryLevel === "_all" || filter.summaryLevel === tableKey)
      ) {
  ...
  renderBucketsFilter(searchQueries, filter, i) {
    ...
    const type =
      (activeView && activeView.es && activeView.es.type) || "contribution";
    const levelsName =
      type === "contribution" ? "Contributions" : _.startCase(type);
    ...
    return (
      ...
      >
        ...
        <div className="right aligned item" style={{ padding: "0 1em" }}>
          <div
            ref="sort"
            className={portals["CDR"].color + " ui dropdown label"}
            style={{ padding: "0.5em" }}
          >
  ...
  renderView(searchQueries, esFilters) {
    ...
    if (activeView.name === "Cores Plots")
      return (
        <SearchCorePlots
          key={this.state.levelNumber + "_" + activeView.name}
          es={es}
