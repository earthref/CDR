          ...
          {Cookies.get('user_id', Meteor.isDevelopment ? {} : { domain: '.earthref.org'}) ?
            <div className="right menu">
              <div className="item" style={{paddingRight: 0}}>
                <Link className={portals['CDR'].color + ' ui compact button'} style={{paddingTop: '0.5em', paddingBottom: '0.5em'}} to="/CDR/private">
                  Private Workspace
                </Link>
              </div>
            </div> : undefined}
        ...
        <div className="ui bottom attached secondary segment" style={this.styles.segment}>
          <div style={{display: 'flex', width: '100%'}}>
            ...
            { this.state.search.indexOf('private_key:') === -1 &&
              <SearchDownload className={portals['CDR'].color + ' ui basic button'} style={{margin: '1em 1em 0 0'}}
                ...
                <div>
                  <div className="ui top attached tabular small menu" style={{paddingLeft: '1em'}}>
                    ...
                    <div className="right aligned item" style={{padding:'0 1em'}}>
                      <div className={'ui small compact button' + (esFilters.length > 0 ? ' ' + portals['CDR'].color : ' basic disabled')} style={{padding:'0.5em'}}
    ...
    return (
      <div ref="tabs" className="ui top attached tabular small menu search-tab-menu">
        ...
        <div className="right aligned item" style={{padding: '0 1em', display: 'none'}}>
          <a className={portals['CDR'].color + ' ui compact button'} style={{padding: '0.5em'}}>
            <i className="ui plus icon"/>
            Custom View
          </a>
        </div>
        <div className="right aligned item" style={{padding: '0 1em'}}>
          <div ref="sort" className={portals['CDR'].color + ' ui dropdown label'} style={{padding: '0.5em'}}>
