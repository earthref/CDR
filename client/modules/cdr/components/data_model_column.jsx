...
export default class extends React.Component {
  ...
  formatValidation(validation) {
    ...
    if (validation === 'required()') {
      ...
      return (
        <span>
          <div className="ui yellow horizontal small label">Validation</div>
      ...
      return (
        <span>
            ...
            master thesis, USGS report, etc.), CDR can store the paper in the ERDA
      ...
      return (
        <span>
          <div className="ui yellow horizontal small label">Vocabulary</div>
          Any values in this column must contain a value found
          in the <Link to={'/CDR/method-codes'}>Method Codes</Link> controlled vocabulary.
        </span>
      );
    }
      ...
      <div>
        <div className="title">
          ...
          {(type || range || ref_validation || user_validation ?
            <div className="ui yellow horizontal small label">Validation</div> : undefined)}
          {(cv_validation || mc_validation || sv_validation ?
            <div className="ui yellow horizontal small label">Vocabulary</div> : undefined)}
          {(foundIn ?
                ...
                <td>
                  {previous.map((x,l) => {
                    return (
                      <span key={l}>
                        {(l > 0 ? <br/> : undefined)}
                        <Link to={'/CDR/data-models/' + previous_version + '/?q=' + x.table + '.' + x.column}>
                          {x.table}.{x.column}
                        </Link>
                      </span>
                    );
