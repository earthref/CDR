    ...
    if (!Cookies.get("user_id", Meteor.isDevelopment ? {} : { domain: '.earthref.org'})) return (
        ...
        <div className="ui top attached segment" ref={(el) => el && el.style.setProperty('width', 'calc(100% + 2px)', 'important')}>
          <div className="ui center aligned two column relaxed grid">
            <div className="column">
              <IconButton
                className="borderless card" href="" portal="CDR"
      ...
      <div>
        <div className="ui list" style={{margin: "0"}}>
          <Link className={portals['CDR'].color + ' ui icon button'} style={{float:'right', margin:'0 0 0.5em'}} to="/CDR/upload">
            <i className="add icon"/> Upload Data Into Your Private Workspace
          </Link>
          <button className={(this.state.activated ? '' : portals['CDR'].color) + ' ui icon button'} style={{margin:'0 1em 0.5em 0'}} onClick={() => { this.setState({ activated: false }, this.updateContributions.bind(this))}}>
            ...
            <div className="ui circular small basic label" style={{color: '#0C0C0C', margin: '-1em -0.5em -1em 0.5em', minWidth: '4em'}}>
              <Count
                es={{ index: 'cdr', type: 'contribution', allVersions: true, filters: [
          ...
          <button className={(!this.state.activated ? '' : portals['CDR'].color) + ' ui icon button'} style={{margin:'0 1em 0.5em 0'}} onClick={() => { this.setState({ activated: true }, this.updateContributions.bind(this))}}>
          ...
          this.privateContributions.map((c,i) => {
            ...
            return (
              <div className="item" key={i} style={{marginBottom: "1.5em"}}>
                <div className={portals["CDR"].color + " ui top attached inverted segment"} style={{padding: "0.5em"}} ref={(el) => el && el.style.setProperty('width', 'calc(100% + 2px)', 'important')}>
                      ...
                      <div className="ui corner labeled fluid small input">
                        ...
                        <Dropdown multiple selection
                          defaultValue={
                            ...
                            (c.summary.contribution.lab_names && c.summary.contribution.lab_names.split && c.summary.contribution.lab_names.split(":")) ||
                            ""
                          }
                ...
                <div className="ui attached secondary segment" style={{padding: "0.5em"}} ref={(el) => el && el.style.setProperty('width', 'calc(100% + 2px)', 'important')}>
                  <div style={{display: "flex", flexFlow: "row wrap"}}>
                    ...
                    {c.summary.contribution._is_activated !== "true" && c.summary.contribution._is_valid === "true" &&
                      <div className={"ui small button " + (hasReference ? portals["CDR"].color : "disabled red")} style={{margin: "0 0 0 0.5em"}}
                        onClick={(e) => {
                    ...
                    <div className={portals["CDR"].color + " ui basic small button"} style={{margin: "0 0 0 0.5em"}}
                        onClick={(e) => {
