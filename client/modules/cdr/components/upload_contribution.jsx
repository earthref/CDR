...
import SummarizeContribution from '/lib/modules/cdr/summarize_contribution.js';
//import ExportContribution from '/client/modules/cdr/actions/export_contribution.js';
...
export default class UploadContribution extends React.Component {
  ...
  parse(i) {
    ...
    this.setState({
      ...
      if (this.state.fileFormats[i] === 'earthref') {
        if (this.files[i].text) {
          ...
          this.files[i].parseErrors.push("Failed to parse this file as an EarthRef Text File.")
        }
      }
  ...
  xlsSheetToArray(sheet) {
    ...
    // Check if this is an EarthRef Excel file by looking for "Group:" in cell A1 and "Column:" in cell A4.
    ...
    if (this.state.parsing) {
      ...
      <DataImporter
        ...
        onReady={(table, columns, rowIdxs) => {
          ...
          this.files[i].nImportErrors = 0; //_.reduce(this.files[i].importErrors, (n, tableErrors) => n + tableErrors.length, 0)
          this.setState({
    ...
    return (
      <div>
        <div ref="segment" className="ui warning message">
          ...
          <br/>
          The <b>Upload Tool</b> is temporarily disabled until <b>2 September, 2017</b> while we make improvements to the system.
        </div>
      </div>
    );
  }
  ...
  render() {
    ...
    if (this.state.uploaded) return <Redirect push to="/CDR/private"/>;
        ...
        <div className="ui top attached segment" ref={(el) => el && el.style.setProperty('width', 'calc(100% + 2px)', 'important')}>
          <div className="ui center aligned two column relaxed grid">
            <div className="column">
              <IconButton
                className="borderless card" portal="CDR"
      ...
      <div className="upload-contribution">
            ...
            <div ref="select step message" className="active content select-step-content">
              ...
              {(step === 1 ?
                <Dropzone ref="dropzone" className="upload-dropzone" onDrop={this.readFiles.bind(this)}>
                  <div className="ui center aligned two column relaxed grid">
                    <div className="column">
                      <i className="huge yellow folder open outline icon"/>
                    ...
                    <div className="column">
                      <i className="huge yellow external icon"/>
              ...
              <div className="ui five stackable cards">
                <IconButton
                  className="borderless card" portal="CDR" position="bottom left"
                ...
                <IconButton
                  className="borderless card" portal="CDR" position="bottom center"
                  tooltip={'Click to upload this example dataset into your private ' +
                  'workspace. You can always delete it later.'}
                ...
                <IconButton
                  className="borderless card" portal="CDR" position="bottom right"
                  tooltip={'Click to upload this example dataset into your private ' +
                  'workspace. You can always delete it later.'}
                        ...
                        <div className="description">
                          ...
                          <div className="ui labeled fluid action input">
                            ...
                            <div className="ui fluid selection dropdown format-dropdown">
                              ...
                              <div className="menu">
                                <div data-i={i} data-value="earthref" 
                                     className={(fileFormat === "earthref" ? "active selected " : "") + "item"}>
                                     EarthRef Text File
                                </div>
                          ...
                          :
                            <div>
                              {(fileFormat === 'earthref' && this.files[i].data && this.files[i].tableNames ?
              ...
              {step === 3 ? <div className="ui items">
                <div className="item">
                  ...
                  <div className="content">
                    ...
                    <br/>
                    {!this.state.uploaded &&
                      <div className={'ui fluid yellow button' + (this.state._name.length > 0 && !this.state.summarizing && !this.state.uploading ? '' : ' disabled')}
        ...
        {(step === 1 ?
          <div className="ui bottom attached icon message">
            <i className="yellow circle info icon"/>
            <div className="content">
        ...
        {(step === 2 &&
          ...
          <div className="ui bottom attached icon success message">
            ...
            <div className="ui right floated yellow button" onClick={this.reviewUpload.bind(this)}>
              Upload
            </div>
          </div>
          : undefined)}
