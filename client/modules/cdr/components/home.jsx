...
import News from '/client/modules/cdr/components/home_news';
      ...
      <React.Fragment>
        <Grid divided><Grid.Row><Grid.Column width={12}>
          <div className="ui three cards">
            <IconButton className="card" link="/CDR/search" portal="CDR">
            ...
            <IconButton className="card" link="/CDR/upload" portal="CDR">
              <i className="large icons">
            ...
            <IconButton className="card" link="/CDR/private" portal="CDR">
              <i className="large icons">
                <i className="file text outline icon"/>
                <i className="corner checkmark icon"/>
              </i>
              <div className="title">Private Workspace</div>
              <div className="subtitle">Manage your contributions to CDR.</div>
            </IconButton>
          </div>
          ...
          <div className="ui two cards" style={{marginTop: 0}}>
            <IconButton className="borderless card" link="/CDR/data-models/1.0" portal="CDR">
              <i className="icons">
            ...
            <IconButton className="borderless card" link="/vocabularies" portal="CDR">
              <i className="icons">
          ...
          <IconButton className="small card" link="/CDR/search" portal="CDR" style={{margin:0}}>
            <div className="small title">View More Contributions in the CDR Search Interface</div>
          </IconButton>
        </Grid.Column>
        <Grid.Column width={4}>
          <News/>
              ...
              <div className="ui divided relaxed items">
                <a className="item">
                  <div className="ui tiny image">
                    <img className="ui bordered image" src={assetUrl('/CDR/plot.png')} style={{border:'1px solid rgba(0, 0, 0, 0.1)'}}/>
                  </div>
                  <div className="content">
