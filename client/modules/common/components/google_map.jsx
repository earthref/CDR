        ...
        try {
          _.uniqBy(s._all._geo_envelope, x => _.flatten(x.coordinates).join('_')).forEach((envelope, i) => {
            if (i == 0) this.addObject(
              ...
              s.contribution && '<a href="/CDR/' + s.contribution.id + '"><b>' + (s.contribution._reference && s.contribution._reference.citation || "Unknown") + 
